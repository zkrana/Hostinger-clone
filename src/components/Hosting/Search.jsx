        ...
        <div className="status-bar">
            <div className="greetings">
                <div class="page-title">
                    ...
                    <h2  class="page-breadcumnb">Hosting</h2>
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb__route"> - <span class="breadcrumb__route__label">Hosting</span></span>
                    </div>
                </div>
            </div>
            <form className='mb-none form-wrapper'>
                <div class="sm:mb-0 input-floating-label searchLabel">
                    ...
                    <label for="input labelSearch">Search for hostings</label>
